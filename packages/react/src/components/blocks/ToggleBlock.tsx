...
export const ToggleBlock: FC<{ block: TToggleBlock }> = ({ block }) => {
  ...
  return (
    <div className="flex items-center">
      <div
        onClick={toggle}
        className={`mr-[4px] w-[24px] h-[22px] flex items-center justify-center cursor-pointer self-start hover:bg-slate-700/[0.07] rounded-[3px] transition-transform rotate-90 ${
